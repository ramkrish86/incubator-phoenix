 ...
 * 
 * @since 0.1 TODO: cleanup implementation to reduce copy/paste duplication
 */
...
public enum PDataType {
    ...
    VARCHAR("VARCHAR", Types.VARCHAR, String.class, null) {
        ...
        public byte[] toBytes(Object object) {
            ...
            if (object == null) { return ByteUtil.EMPTY_BYTE_ARRAY; }
        ...
        public Object toObject(byte[] bytes, int offset, int length, PDataType actualType, SortOrder sortOrder,
            ...
            if (!actualType.isCoercibleTo(this)) { throw new ConstraintViolationException(actualType
                    + " cannot be coerced to " + this); }
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            if (isCoercibleTo(targetType)) {
                if (targetType == PDataType.CHAR) { return value != null; }
                return true;
            }
            return false;
        }
        ...
        public boolean isSizeCompatible(ImmutableBytesWritable ptr, Object value, PDataType srcType, Integer maxLength,
            ...
            if (ptr.getLength() != 0 && maxLength != null && desiredMaxLength != null) { return maxLength <= desiredMaxLength; }
            return true;
        }
    ...
    CHAR("CHAR", Types.CHAR, String.class, null) { // Delegate to VARCHAR
        ...
        public Object pad(Object object, int maxLength) {
            String s = (String)object;
            if (s == null) { return s; }
            if (s.length() == maxLength) { return object; }
            if (s.length() > maxLength) { throw new ValueTypeIncompatibleException(this, maxLength, null); }
        ...
        public byte[] toBytes(Object object) {
            ...
            if (b.length != ((String)object).length()) { throw new IllegalDataException(
                    "CHAR types may only contain single byte characters (" + object + ")"); }
            return b;
        }
        ...
        public int toBytes(Object object, byte[] bytes, int offset) {
            ...
            if (len != ((String)object).length()) { throw new IllegalDataException(
                    "CHAR types may only contain single byte characters (" + object + ")"); }
            return len;
        }
        ...
        public Object toObject(byte[] bytes, int offset, int length, PDataType actualType, SortOrder sortOrder,
            ...
            if (length != s.length()) { throw new IllegalDataException(
                    "CHAR types may only contain single byte characters (" + s + ")"); }
            return s;
        }
        ...
        public void coerceBytes(ImmutableBytesWritable ptr, Object o, PDataType actualType, Integer actualMaxLength,
            ...
            if (o != null && actualType == PDataType.VARCHAR && ((String)o).length() != ptr.getLength()) { throw new IllegalDataException(
                    "CHAR types may only contain single byte characters (" + o + ")"); }
            super.coerceBytes(ptr, o, actualType, actualMaxLength, actualScale, actualModifier, desiredMaxLength,
        ...
        @Override
        public Object toObject(String value) {
            if (value == null || value.length() == 0) { throw new ConstraintViolationException(this
                    + " may not be null"); }
            if (StringUtil.hasMultiByteChars(value)) { throw new IllegalDataException(
                    "CHAR types may only contain single byte characters (" + value + ")"); }
            return value;
        }
    ...
    LONG("BIGINT", Types.BIGINT, Long.class, new LongCodec()) {
        ...
        public Object toObject(Object object, PDataType actualType) {
            ...
            case UNSIGNED_FLOAT:
                ...
                if (f > Long.MAX_VALUE || f < Long.MIN_VALUE) { throw new IllegalDataException(actualType + " value "
                        + f + " cannot be cast to Long without changing its value"); }
                s = f.longValue();
                return s;
            case DOUBLE:
            case UNSIGNED_DOUBLE:
                Double de = (Double)object;
                if (de > Long.MAX_VALUE || de < Long.MIN_VALUE) { throw new IllegalDataException(actualType + " value "
                        + de + " cannot be cast to Long without changing its value"); }
                s = de.longValue();
                return s;
            case DECIMAL:
        ...
        @Override
        public Long toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength,
                Integer scale) {
            if (l == 0) { return null; }
            switch (actualType) {
            case LONG:
        ...
        public int compareTo(Object lhs, Object rhs, PDataType rhsType) {
            ...
            } else if (rhsType == DOUBLE || rhsType == FLOAT || rhsType == UNSIGNED_DOUBLE || rhsType == UNSIGNED_FLOAT) { return Doubles
                    .compare(((Number)lhs).doubleValue(), ((Number)rhs).doubleValue()); }
    ...
    INTEGER("INTEGER", Types.INTEGER, Integer.class, new IntCodec()) {
        ...
        public Object toObject(Object object, PDataType actualType) {
            ...
            if (!(o instanceof Long) || o == null) { return o; }
            long l = (Long)o;
            if (l < Integer.MIN_VALUE || l > Integer.MAX_VALUE) { throw new IllegalDataException(actualType + " value "
                    + l + " cannot be cast to Integer without changing its value"); }
            int v = (int)l;
            return v;
        }

        @Override
        public Integer toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength,
                Integer scale) {
            if (l == 0) { return null; }
            switch (actualType) {
            case LONG:
    ...
    SMALLINT("SMALLINT", Types.SMALLINT, Short.class, new ShortCodec()) {
        ...
        public Object toObject(Object object, PDataType actualType) {
            ...
            if (!(o instanceof Long) || o == null) { return o; }
            long l = (Long)o;
            if (l < Short.MIN_VALUE || l > Short.MAX_VALUE) { throw new IllegalDataException(actualType + " value " + l
                    + " cannot be cast to Short without changing its value"); }
            short s = (short)l;
            return s;
        }

        @Override
        public Short toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength,
                Integer scale) {
            if (l == 0) { return null; }
            switch (actualType) {
            case SMALLINT:
    ...
    TINYINT("TINYINT", Types.TINYINT, Byte.class, new ByteCodec()) {
        ...
        public Object toObject(Object object, PDataType actualType) {
            ...
            if (!(o instanceof Long) || o == null) { return o; }
            long l = (Long)o;
            if (l < Byte.MIN_VALUE || l > Byte.MAX_VALUE) { throw new IllegalDataException(actualType + " value " + l
                    + " cannot be cast to Byte without changing its value"); }
            return (byte)l;
        }

        @Override
        public Byte toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength,
                Integer scale) {
            if (l == 0) { return null; }
            switch (actualType) {
            case UNSIGNED_DOUBLE:
    ...
    FLOAT("FLOAT", Types.FLOAT, Float.class, new FloatCodec()) {
        ...
        public Object toObject(Object object, PDataType actualType) {
            ...
            case UNSIGNED_DOUBLE:
                ...
                if (Double.isNaN(d) || d == Double.POSITIVE_INFINITY || d == Double.NEGATIVE_INFINITY
                    ...
                    throw new IllegalDataException(actualType + " value " + d
                            + " cannot be cast to Float without changing its value");
                }
            case LONG:
            case UNSIGNED_LONG:
                float f = (Long)object;
        ...
        @Override
        public Float toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength,
                Integer scale) {
            if (l <= 0) { return null; }
            switch (actualType) {
            case FLOAT:
    ...
    DOUBLE("DOUBLE", Types.DOUBLE, Double.class, new DoubleCodec()) {
        ...
        @Override
        public int compareTo(Object lhs, Object rhs, PDataType rhsType) {
            if (rhsType == DECIMAL) { return -((BigDecimal)rhs).compareTo(BigDecimal.valueOf(((Number)lhs)
                    .doubleValue())); }
        ...
        @Override
        public Double toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength,
                Integer scale) {
            if (l <= 0) { return null; }
            switch (actualType) {
            case DOUBLE:
    ...
    DECIMAL("DECIMAL", Types.DECIMAL, BigDecimal.class, null) {
        ...
        private int getLength(BigDecimal v) {
            ...
            /*
             * Size of DECIMAL includes: 1) one byte for exponent 2) one byte for terminal byte if negative 3) one byte
             * for every two digits with the following caveats: a) add one to round up in the case when there is an odd
             * number of digits b) add one in the case that the scale is odd to account for 10x of lowest significant
             * digit (basically done to increase the range of exponents that can be represented)
             */
        ...
        @Override
        public Integer getMaxLength(Object o) {
            if (o == null) { return MAX_PRECISION; }
            BigDecimal v = (BigDecimal)o;
            return v.precision();
        }
        ...
        @Override
        public Object toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength,
                Integer scale) {
            ...
            case UNSIGNED_TIMESTAMP:
                ...
                BigDecimal nanosPart = BigDecimal.valueOf((nanoPart % QueryConstants.MILLIS_TO_NANOS_CONVERTOR)
        ...
        public Object toObject(Object object, PDataType actualType) {
            ...
            case UNSIGNED_TIMESTAMP:
                ...
                BigDecimal nanosPart = BigDecimal.valueOf((ts.getNanos() % QueryConstants.MILLIS_TO_NANOS_CONVERTOR)
                        / QueryConstants.MILLIS_TO_NANOS_CONVERTOR);
                BigDecimal value = BigDecimal.valueOf(millisPart).add(nanosPart);
                return value;
            case BOOLEAN:
        ...
        @Override
        public int compareTo(Object lhs, Object rhs, PDataType rhsType) {
            if (rhsType == DECIMAL) { return ((BigDecimal)lhs).compareTo((BigDecimal)rhs); }
        ...
        public boolean isSizeCompatible(ImmutableBytesWritable ptr, Object value, PDataType srcType, Integer maxLength,
            ...
            if (desiredMaxLength != null
                    ...
                    && maxLength != null
                    && scale != null
                    && ((desiredScale == null && desiredMaxLength < maxLength) || (desiredMaxLength - desiredScale) < (maxLength - scale))) { return false; }
            return true;
        }

        @Override
        public void coerceBytes(ImmutableBytesWritable ptr, Object object, PDataType actualType, Integer maxLength,
                Integer scale, SortOrder actualModifier, Integer desiredMaxLength, Integer desiredScale,
                SortOrder expectedModifier) {
    ...
    TIMESTAMP("TIMESTAMP", Types.TIMESTAMP, Timestamp.class, new DateCodec()) {
        ...
        public int toBytes(Object object, byte[] bytes, int offset) {
            ...
            /*
             * By not getting the stuff that got spilled over from the millis part, it leaves the timestamp's byte
             * representation saner - 8 bytes of millis | 4 bytes of nanos. Also, it enables timestamp bytes to be
             * directly compared with date/time bytes.
             */
        ...
        @Override
        public Timestamp toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength,
                Integer scale) {
            if (actualType == null || l == 0) { return null; }
            switch (actualType) {
            case TIMESTAMP:
            case UNSIGNED_TIMESTAMP:
                long millisDeserialized = (actualType == TIMESTAMP ? DATE : UNSIGNED_DATE).getCodec().decodeLong(b, o,
                        sortOrder);
                Timestamp v = new Timestamp(millisDeserialized);
                int nanosDeserialized = PDataType.UNSIGNED_INT.getCodec()
                        .decodeInt(b, o + Bytes.SIZEOF_LONG, sortOrder);
                /*
                 * There was a bug in serialization of timestamps which was causing the sub-second millis part of time
                 * stamp to be present both in the LONG and INT bytes. Having the <100000 check makes this serialization
        ...
        @Override
        public int compareTo(Object lhs, Object rhs, PDataType rhsType) {
            if (rhsType == TIMESTAMP || rhsType == UNSIGNED_TIMESTAMP) { return ((Timestamp)lhs)
                    .compareTo((Timestamp)rhs); }
        ...
        public int getNanos(ImmutableBytesWritable ptr, SortOrder sortOrder) {
            int nanos = PDataType.UNSIGNED_INT.getCodec().decodeInt(ptr.get(),
                    ptr.getOffset() + PDataType.LONG.getByteSize(), sortOrder);
            return nanos;
        }
    ...
    TIME("TIME", Types.TIME, Time.class, new DateCodec()) {
        ...
        @Override
        public Time toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength,
                Integer scale) {
            if (l == 0) { return null; }
            switch (actualType) {
            case TIMESTAMP:
    ...
    DATE("DATE", Types.DATE, Date.class, new DateCodec()) { // After TIMESTAMP and DATE to ensure toLiteral finds those
                                                            // first
        ...
        @Override
        public Date toObject(byte[] b, int o, int l, PDataType actualType, SortOrder sortOrder, Integer maxLength,
                Integer scale) {
            if (l == 0) { return null; }
            switch (actualType) {
            case TIMESTAMP:
        ...
        @Override
        public boolean isCastableTo(PDataType targetType) {
            return super.isCastableTo(targetType) || targetType == DECIMAL || targetType == LONG
                    || targetType == UNSIGNED_LONG;
        }

        @Override
        public boolean isCoercibleTo(PDataType targetType) {
            return targetType == DATE || targetType == TIME || targetType == TIMESTAMP || targetType == VARBINARY
                    || targetType == BINARY;
        }
        ...
        @Override
        public int compareTo(Object lhs, Object rhs, PDataType rhsType) {
            if (rhsType == TIMESTAMP || rhsType == UNSIGNED_TIMESTAMP) { return -rhsType.compareTo(rhs, lhs, TIME); }
    ...
    UNSIGNED_DATE("UNSIGNED_DATE", 19, Date.class, new UnsignedDateCodec()) { // After TIMESTAMP and DATE to ensure
    ...
    /**
     * Unsigned long type that restricts values to be from 0 to {@link java.lang.Long#MAX_VALUE} inclusive. May be used
     * to map to existing HTable values created through {@link org.apache.hadoop.hbase.util.Bytes#toBytes(long)} as long
     * as all values are non negative (the leading sign bit of negative numbers would cause them to sort ahead of
     * positive numbers when they're used as part of the row key when using the HBase utility methods).
     */
    UNSIGNED_LONG("UNSIGNED_LONG", 10 /* no constant available in Types */, Long.class, new UnsignedLongCodec()) {
        ...
        public Object toObject(String value) {
            ...
            try {
                ...
                if (l.longValue() < 0) { throw new IllegalDataException("Value may not be negative(" + l + ")"); }
                return l;
            } catch (NumberFormatException e) {
                throw new IllegalDataException(e);
            }
    ...
    /**
     * Unsigned integer type that restricts values to be from 0 to {@link java.lang.Integer#MAX_VALUE} inclusive. May be
     * used to map to existing HTable values created through {@link org.apache.hadoop.hbase.util.Bytes#toBytes(int)} as
     * long as all values are non negative (the leading sign bit of negative numbers would cause them to sort ahead of
     * positive numbers when they're used as part of the row key when using the HBase utility methods).
     */
    UNSIGNED_INT("UNSIGNED_INT", 9 /* no constant available in Types */, Integer.class, new UnsignedIntCodec()) {
        ...
        @Override
        public boolean isCoercibleTo(PDataType targetType) {
            return targetType == this || targetType == UNSIGNED_FLOAT || UNSIGNED_LONG.isCoercibleTo(targetType)
                    || INTEGER.isCoercibleTo(targetType);
        }
        ...
        public Object toObject(String value) {
            ...
            try {
                ...
                if (i.intValue() < 0) { throw new IllegalDataException("Value may not be negative(" + i + ")"); }
                return i;
            } catch (NumberFormatException e) {
                throw new IllegalDataException(e);
            }
    ...
    UNSIGNED_SMALLINT("UNSIGNED_SMALLINT", 13, Short.class, new UnsignedShortCodec()) {
        ...
        public Object toObject(String value) {
            ...
            try {
                ...
                if (b.shortValue() < 0) { throw new IllegalDataException("Value may not be negative(" + b + ")"); }
                return b;
            } catch (NumberFormatException e) {
                throw new IllegalDataException(e);
            }
    ...
    UNSIGNED_TINYINT("UNSIGNED_TINYINT", 11, Byte.class, new UnsignedByteCodec()) {
        ...
        public Object toObject(String value) {
            ...
            try {
                Byte b = Byte.parseByte(value);
                if (b.byteValue() < 0) { throw new IllegalDataException("Value may not be negative(" + b + ")"); }
                return b;
            } catch (NumberFormatException e) {
                throw new IllegalDataException(e);
            }
        ...
        @Override
        public boolean isCoercibleTo(PDataType targetType) {
            return targetType == this || UNSIGNED_SMALLINT.isCoercibleTo(targetType)
                    || TINYINT.isCoercibleTo(targetType);
        }
    ...
    UNSIGNED_FLOAT("UNSIGNED_FLOAT", 14, Float.class, new UnsignedFloatCodec()) {
        ...
        public Object toObject(String value) {
            ...
            try {
                ...
                if (f.floatValue() < 0) { throw new IllegalDataException("Value may not be negative(" + f + ")"); }
                return f;
            } catch (NumberFormatException e) {
                throw new IllegalDataException(e);
            }
    ...
    UNSIGNED_DOUBLE("UNSIGNED_DOUBLE", 15, Double.class, new UnsignedDoubleCodec()) {
        ...
        public Object toObject(String value) {
            ...
            try {
                ...
                if (d.doubleValue() < 0) { throw new IllegalDataException("Value may not be negative(" + d + ")"); }
                return d;
            } catch (NumberFormatException e) {
                throw new IllegalDataException(e);
            }
    ...
    BOOLEAN("BOOLEAN", Types.BOOLEAN, Boolean.class, null) {
        ...
        @Override
        public Boolean toObject(byte[] bytes, int offset, int length, PDataType actualType, SortOrder sortOrder,
                Integer maxLength, Integer scale) {
            Preconditions.checkNotNull(sortOrder);
            if (length == 0) { return null; }
            switch (actualType) {
            case BOOLEAN:
                if (length > 1) { throw new IllegalDataException("BOOLEAN may only be a single byte"); }
        ...
        @Override
        public Object toObject(Object object, PDataType actualType) {
            if (actualType == this || object == null) { return object; }
    ...
    VARBINARY("VARBINARY", Types.VARBINARY, byte[].class, null) {
        ...
        public byte[] toBytes(Object object, SortOrder sortOrder) {
            ...
            if (sortOrder == SortOrder.DESC) { return SortOrder.invert(bytes, 0, new byte[bytes.length], 0,
                    bytes.length); }
            return bytes;
        }
        ...
        public Object toObject(byte[] bytes, int offset, int length, PDataType actualType, SortOrder sortOrder,
                Integer maxLength, Integer scale) {
            if (length == 0) { return null; }
            if (offset == 0 && bytes.length == length && sortOrder == SortOrder.ASC) { return bytes; }
        ...
        public boolean isSizeCompatible(ImmutableBytesWritable ptr, Object value, PDataType srcType, Integer maxLength,
                Integer scale, Integer desiredMaxLength, Integer desiredScale) {
            if (ptr.getLength() != 0 && srcType == PDataType.BINARY && maxLength != null && desiredMaxLength != null) { return maxLength <= desiredMaxLength; }
            return true;
        }
        ...
        public String toStringLiteral(byte[] b, int o, int length, Format formatter) {
            if (formatter != null) { return formatter.format(b); }
    ...
    BINARY("BINARY", Types.BINARY, byte[].class, null) {
        ...
        public Object pad(Object object, int maxLength) {
            ...
            if (b.length == maxLength) { return object; }
            if (b.length > maxLength) { throw new ValueTypeIncompatibleException(this, maxLength, null); }
        ...
        public boolean isSizeCompatible(ImmutableBytesWritable ptr, Object value, PDataType srcType, Integer maxLength,
                Integer scale, Integer desiredMaxLength, Integer desiredScale) {
            if (ptr.getLength() != 0
                    && ((srcType == PDataType.VARBINARY && ((String)value).length() != ptr.getLength()) || (maxLength != null
                            && desiredMaxLength != null && maxLength > desiredMaxLength))) { return false; }
            return true;
        }
        ...
        @Override
        public String toStringLiteral(byte[] b, int offset, int length, Format formatter) {
            if (formatter == null && b.length == 1) { return Integer.toString(0xFF & b[0]); }
    ...
    INTEGER_ARRAY("INTEGER_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.INTEGER.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (int i : intArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.INTEGER, i)) { return false; }
            }
            return true;
        }
    ...
    BOOLEAN_ARRAY("BOOLEAN_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.BOOLEAN.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (boolean i : booleanArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.BOOLEAN, i)) { return false; }
            }
            return true;
        }
    ...
    VARCHAR_ARRAY("VARCHAR_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.VARCHAR.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (Object i : charArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.VARCHAR, i)) { return false; }
            }
            return true;
        }
    ...
    VARBINARY_ARRAY("VARBINARY_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.VARBINARY.getSqlType(),
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            Object[] charArr = (Object[])pArr.array;
            for (Object i : charArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.VARBINARY, i)) { return false; }
            }
            return true;
        }
    ...
    BINARY_ARRAY("BINARY_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.BINARY.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            Object[] charArr = (Object[])pArr.array;
            for (Object i : charArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.BINARY, i)) { return false; }
            }
            return true;
        }
    ...
    CHAR_ARRAY("CHAR_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.CHAR.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            Object[] charArr = (Object[])pArr.array;
            for (Object i : charArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.CHAR, i)) { return false; }
            }
            return true;
        }
    ...
    LONG_ARRAY("LONG_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.LONG.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (long i : longArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.LONG, i)) { return false; }
            }
            return true;
        }
    ...
    SMALLINT_ARRAY("SMALLINT_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.SMALLINT.getSqlType(), PhoenixArray.class,
            null) {
        @Override
        public boolean isArrayType() {
            return true;
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (short i : shortArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.SMALLINT, i)) { return false; }
            }
            return true;
        }
    ...
    TINYINT_ARRAY("TINYINT_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.TINYINT.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (byte i : byteArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.TINYINT, i)) { return false; }
            }
            return true;
        }
    ...
    FLOAT_ARRAY("FLOAT_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.FLOAT.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (float i : floatArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.FLOAT, i)) { return false; }
            }
            return true;
        }
    ...
    DOUBLE_ARRAY("DOUBLE_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.DOUBLE.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (double i : doubleArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.DOUBLE, i)) { return false; }
            }
            return true;
        }
    ...
    DECIMAL_ARRAY("DECIMAL_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.DECIMAL.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (Object i : decimalArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.DECIMAL, i)) { return false; }
            }
            return true;
        }
    ...
    TIMESTAMP_ARRAY("TIMESTAMP_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.TIMESTAMP.getSqlType(),
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (Object i : timeStampArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.TIMESTAMP, i)) { return false; }
            }
            return true;
        }
    ...
    UNSIGNED_TIMESTAMP_ARRAY("UNSIGNED_TIMESTAMP_ARRAY", PDataType.ARRAY_TYPE_BASE
            + PDataType.UNSIGNED_TIMESTAMP.getSqlType(), PhoenixArray.class, null) {
        @Override
        public boolean isArrayType() {
            return true;
        }
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            Object[] timeStampArr = (Object[])pArr.array;
            for (Object i : timeStampArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_TIMESTAMP, i)) { return false; }
            }
            return true;
        }
    ...
    TIME_ARRAY("TIME_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.TIME.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (Object i : timeArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.TIME, i)) { return false; }
            }
            return true;
        }
    ...
    UNSIGNED_TIME_ARRAY("UNSIGNED_TIME_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.UNSIGNED_TIME.getSqlType(),
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            Object[] timeArr = (Object[])pArr.array;
            for (Object i : timeArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_TIME, i)) { return false; }
            }
            return true;
        }
    ...
    DATE_ARRAY("DATE_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.DATE.getSqlType(), PhoenixArray.class, null) {
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (Object i : dateArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.DATE, i)) { return false; }
            }
            return true;
        }
    ...
    UNSIGNED_DATE_ARRAY("UNSIGNED_DATE_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.UNSIGNED_DATE.getSqlType(),
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            Object[] dateArr = (Object[])pArr.array;
            for (Object i : dateArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_DATE, i)) { return false; }
            }
            return true;
        }
    ...
    UNSIGNED_LONG_ARRAY("UNSIGNED_LONG_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.UNSIGNED_LONG.getSqlType(),
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            long[] longArr = (long[])pArr.array;
            for (long i : longArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_LONG, i)) { return false; }
            }
            return true;
        }
    ...
    UNSIGNED_INT_ARRAY("UNSIGNED_INT_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.UNSIGNED_INT.getSqlType(),
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            int[] intArr = (int[])pArr.array;
            for (int i : intArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_INT, i)) { return false; }
            }
            return true;
        }
    ...
    UNSIGNED_SMALLINT_ARRAY("UNSIGNED_SMALLINT_ARRAY", PDataType.ARRAY_TYPE_BASE
            + PDataType.UNSIGNED_SMALLINT.getSqlType(), PhoenixArray.class, null) {
        @Override
        public boolean isArrayType() {
            return true;
        }
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            short[] shortArr = (short[])pArr.array;
            for (short i : shortArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_SMALLINT, i)) { return false; }
            }
            return true;
        }
    ...
    UNSIGNED_TINYINT_ARRAY("UNSIGNED_TINYINT__ARRAY", PDataType.ARRAY_TYPE_BASE
            + PDataType.UNSIGNED_TINYINT.getSqlType(), PhoenixArray.class, null) {
        @Override
        public boolean isArrayType() {
            return true;
        }
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            byte[] byteArr = (byte[])pArr.array;
            for (byte i : byteArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_TINYINT, i)) { return false; }
            }
            return true;
        }
    ...
    UNSIGNED_FLOAT_ARRAY("UNSIGNED_FLOAT_ARRAY", PDataType.ARRAY_TYPE_BASE + PDataType.UNSIGNED_FLOAT.getSqlType(),
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            float[] floatArr = (float[])pArr.array;
            for (float i : floatArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_FLOAT, i)) { return false; }
            }
            return true;
        }
        ...
        public boolean isCoercibleTo(PDataType targetType, Object value) {
            ...
            for (double i : doubleArr) {
                if (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_DOUBLE, i)
                        && (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_TIMESTAMP, i))
                        && (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_TIME, i))
                        && (!pDataTypeForArray.isCoercibleTo(PDataType.UNSIGNED_DATE, i))) { return false; }
            }
            return true;
        }
    ...
    public boolean isBytesComparableWith(PDataType otherType) {
        return this == otherType || this == PDataType.VARBINARY || otherType == PDataType.VARBINARY
                || this == PDataType.BINARY || otherType == PDataType.BINARY;
    }
    ...
    public final int compareTo(byte[] lhs, int lhsOffset, int lhsLength, SortOrder lhsSortOrder, byte[] rhs,
        ...
        if (lhsCodec == null) { // no lhs native type representation, so convert rhsType to bytes representation of
                                // lhsType
        ...
        if (this.isCoercibleTo(PDataType.LONG) && rhsType.isCoercibleTo(PDataType.LONG)) { // native long to long
                                                                                           // comparison
    ...
    public static boolean isDoubleOrFloat(PDataType type) {
        return type == PDataType.FLOAT || type == PDataType.DOUBLE || type == PDataType.UNSIGNED_FLOAT
                || type == PDataType.UNSIGNED_DOUBLE;
    }
    ...
    public static class LongCodec extends BaseCodec {
        ...
        public int decodeInt(byte[] b, int o, SortOrder sortOrder) {
            ...
            if (v < Integer.MIN_VALUE || v > Integer.MAX_VALUE) { throw new IllegalDataException("Value " + v
        ...
        @Override
        public int encodeFloat(float v, byte[] b, int o) {
            if (v < Long.MIN_VALUE || v > Long.MAX_VALUE) { throw new IllegalDataException("Value " + v
                    + " cannot be encoded as an Long without changing its value"); }
        ...
        public byte decodeByte(byte[] b, int o, SortOrder sortOrder) {
            long v = decodeLong(b, o, sortOrder);
            if (v < Byte.MIN_VALUE || v > Byte.MAX_VALUE) { throw new IllegalDataException("Value " + v
                    + " cannot be cast to Byte without changing its value"); }
            return (byte)v;
        }
        ...
        public short decodeShort(byte[] b, int o, SortOrder sortOrder) {
            long v = decodeLong(b, o, sortOrder);
            if (v < Short.MIN_VALUE || v > Short.MAX_VALUE) { throw new IllegalDataException("Value " + v
                    + " cannot be cast to Short without changing its value"); }
            return (short)v;
        }
    ...
    public static class IntCodec extends BaseCodec {
        ...
        public int encodeFloat(float v, byte[] b, int o) {
            if (v < Integer.MIN_VALUE || v > Integer.MAX_VALUE) { throw new IllegalDataException("Value " + v
                    + " cannot be encoded as an Integer without changing its value"); }
    ...
    public static class ShortCodec extends BaseCodec {
        ...
        public int encodeLong(long v, byte[] b, int o) {
            if (v < Short.MIN_VALUE || v > Short.MAX_VALUE) { throw new IllegalDataException("Value " + v
                    + " cannot be encoded as an Short without changing its value"); }
    ...
    public static class ByteCodec extends BaseCodec {
        ...
        public int encodeShort(short v, byte[] b, int o) {
            if (v < Byte.MIN_VALUE || v > Byte.MAX_VALUE) { throw new IllegalDataException("Value " + v
                    + " cannot be encoded as an Byte without changing its value"); }
    ...
    public static class UnsignedByteCodec extends ByteCodec {
        ...
        public byte decodeByte(byte[] b, int o, SortOrder sortOrder) {
            ...
            byte v = b[o];
            if (v < 0) { throw new IllegalDataException(); }
            return v;
        }
    ...
    public static class FloatCodec extends BaseCodec {
        ...
        public long decodeLong(byte[] b, int o, SortOrder sortOrder) {
            ...
            if (v < Long.MIN_VALUE || v > Long.MAX_VALUE) { throw new IllegalDataException("Value " + v
                    + " cannot be cast to Long without changing its value"); }
            return (long)v;
        }
        ...
        public int encodeDouble(double v, byte[] b, int o) {
            if (Double.isNaN(v) || v == Double.POSITIVE_INFINITY || v == Double.NEGATIVE_INFINITY
                ...
                throw new IllegalDataException("Value " + v
                        + " cannot be encoded as an Float without changing its value");
            }
    ...
    public static class DoubleCodec extends BaseCodec {
        ...
        public float decodeFloat(byte[] b, int o, SortOrder sortOrder) {
            double v = decodeDouble(b, o, sortOrder);
            if (Double.isNaN(v) || v == Double.NEGATIVE_INFINITY || v == Double.POSITIVE_INFINITY
                    || (v >= -Float.MAX_VALUE && v <= Float.MAX_VALUE)) {
                return (float)v;
            } else {
    ...
    public static final int MAX_PRECISION = 38; // Max precision guaranteed to fit into a long (and this should be
                                                // plenty)
    ...
    private static void throwIfNonNegativeDate(java.util.Date date) {
        if (!isNonNegativeDate(date)) { throw new IllegalDataException("Value may not be negative(" + date + ")"); }
    }
    ...
    private static void throwIfNonNegativeNumber(Number v) {
        if (!isNonNegativeNumber(v)) { throw new IllegalDataException("Value may not be negative(" + v + ")"); }
    }
    ...
    static {
        ImmutableMap.Builder<String, PDataType> builder = ImmutableMap.<String, PDataType> builder();
    ...
    public String toStringLiteral(byte[] b, int offset, int length, Format formatter) {
        Object o = toObject(b, offset, length);
        if (formatter != null) { return formatter.format(o); }
        return o.toString();
    }
    ...
    public static PhoenixArray instantiatePhoenixArray(PDataType actualType, Object[] elements) {
        ...
        if (factory == null) { throw new IllegalArgumentException("Cannot create an array of " + actualType); }
